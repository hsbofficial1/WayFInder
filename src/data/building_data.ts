        ...
        floors: [
            {
                ...
                nodes: [
                    ...
                    // Rooms / Entries / Exits
                    { node_id: "Reception_G", node_type: "entry", category: "entry", name: "Reception", floor: "G", junction_id: "J1_G", image: "/assets/panoramas/Reception.jpg", cue: "the main welcome desk" },
                    { node_id: "EntryGate_G", node_type: "exit", category: "utility", name: "Entry Gate", floor: "G", junction_id: "J1_G", image: "/assets/panoramas/Entry Gate.jpg", cue: "the proper exit from the building" },
                    { node_id: "ASAP_G", node_type: "room", category: "office", name: "ASAP Office", floor: "G", junction_id: "J2_G", image: "/assets/panoramas/j2.jpg", cue: "the ASAP Branding office" },
                    { node_id: "EmergencyExit_G", node_type: "exit", category: "utility", name: "Emergency Exit", floor: "G", junction_id: "J3_G", image: "/assets/panoramas/j3.jpg", cue: "the corner exit sign" },
                    { node_id: "Lift1_G", node_type: "lift", category: "utility", name: "Lift 1", floor: "G", junction_id: "J4_G", image: "/assets/panoramas/j4.jpg", cue: "the elevator bank" },
                    { node_id: "StairsRight1_G", node_type: "stairs", category: "utility", name: "Stairs Right 1", floor: "G", junction_id: "J5_G", image: "/assets/panoramas/j5.jpg", cue: "the right side stairs" },
                    { node_id: "KSUM_G", node_type: "room", category: "office", name: "Leap / Mission Start up Kerala", floor: "G", junction_id: "J6_G", image: "/assets/panoramas/j6.jpg", cue: "the Mission Start up Kerala / Leap center" },
                    { node_id: "Openmind_G", node_type: "room", category: "hotspot", name: "Openmind", floor: "G", junction_id: "J7_G", image: "/assets/panoramas/j7.jpg", cue: "the innovation hub and makerspace" },
                    { node_id: "SaneRoom_G", node_type: "room", category: "room", name: "The Sane Room", floor: "G", junction_id: "J8_G", image: "/assets/panoramas/j8.jpg", cue: "the quiet focus zone" },
                    { node_id: "AUAS_G", node_type: "room", category: "office", name: "Autonomous AUAS", floor: "G", junction_id: "J9_G", image: "/assets/panoramas/j9.jpg", cue: "the Autonomous Systems lab" },
                    { node_id: "Unknown1_G", node_type: "room", category: "room", name: "Empty Room", floor: "G", junction_id: "J10_G", image: "/assets/panoramas/j10.jpg" },
                    { node_id: "Washroom1_G", node_type: "room", category: "utility", name: "Washroom 1", floor: "G", junction_id: "J11_G", image: "/assets/panoramas/j11.jpg", cue: "the nearby restroom" },
                    { node_id: "DiningHall_G", node_type: "room", category: "hotspot", name: "Dining Hall", floor: "G", junction_id: "J12_G", image: "/assets/panoramas/Dining Hall.jpg", cue: "the cafeteria and dining area" },
                    { node_id: "FirstAid_G", node_type: "room", category: "utility", name: "First Aid Room", floor: "G", junction_id: "J12_G", image: "/assets/panoramas/j12.jpg", cue: "the medical cross room" },
            ...
            },
            {
                ...
                nodes: [
                    ...
                    // Rooms
                    { node_id: "RuffinRange_F1", node_type: "room", category: "room", name: "Rappin Range", floor: "F1", junction_id: "J13_F1", image: "/assets/panoramas/rappin range.jpg", cue: "the Rappin Range area" },
                    { node_id: "Stairs5_F1", node_type: "stairs", category: "utility", name: "Stairs 3", floor: "F1", junction_id: "J13_F1", image: "/assets/panoramas/j13.jpg" },
                    { node_id: "Washroom2_F1", node_type: "room", category: "utility", name: "Washroom 2", floor: "F1", junction_id: "J13_F1", image: "/assets/panoramas/j13.jpg", cue: "the washroom" },
                    { node_id: "CrownDown_F1", node_type: "room", category: "room", name: "Crown Down", floor: "F1", junction_id: "J14_F1", image: "/assets/panoramas/j14.jpg", cue: "the Crown Down room" },
                    { node_id: "Unknown2_F1", node_type: "room", category: "room", name: "Unknown Room 2", floor: "F1", junction_id: "J15_F1", image: "/assets/panoramas/j15.jpg", cue: "the unknown room" },
                    { node_id: "AdminOffice_F1", node_type: "room", category: "office", name: "Administrative Office", floor: "F1", junction_id: "J16_F1", image: "/assets/panoramas/j16.jpg", cue: "the Administrative Office" },
                    { node_id: "Lift2_F1", node_type: "lift", category: "utility", name: "Lift 2", floor: "F1", junction_id: "J18_F1", image: "/assets/panoramas/j18.jpg" },
                    { node_id: "Foursquare_F1", node_type: "room", category: "hotspot", name: "Foursquare", floor: "F1", junction_id: "J20_F1", image: "/assets/panoramas/j20.jpg", cue: "the Foursquare area" },
                    { node_id: "Stairs4_F1", node_type: "stairs", category: "utility", name: "Stairs 4", floor: "F1", junction_id: "J20_F1", image: "/assets/panoramas/j20.jpg" },
                    { node_id: "NoodlingSpace_F1", node_type: "room", category: "hotspot", name: "Noodlin Space", floor: "F1", junction_id: "J21_F1", image: "/assets/panoramas/j21.jpg", cue: "the Noodlin Space" },
                    { node_id: "PremiumSpace_F1", node_type: "room", category: "hotspot", name: "Cranium Space", floor: "F1", junction_id: "J22_F1", image: "/assets/panoramas/j22.jpg", cue: "the Cranium Space" },
                    { node_id: "ServerRoom_F1", node_type: "room", category: "utility", name: "Server Room", floor: "F1", junction_id: "J23_F1", image: "/assets/panoramas/j23.jpg", cue: "the Server Room" },
                    { node_id: "FocusSpace_F1", node_type: "room", category: "hotspot", name: "Focus Space", floor: "F1", junction_id: "J24_F1", image: "/assets/panoramas/j24.jpg", cue: "the Focus Space" },
                    { node_id: "CW_F1", node_type: "room", category: "room", name: "Curiosity Weekends", floor: "F1", junction_id: "J25_F1", image: "/assets/panoramas/curiosity weekends (cw).jpg", cue: "the Curiosity Weekends room" }
                ],
                edges: [
